  ...
  Annotation.prototype.bindListener = function (card, itemId) {
    ...
    if (editable) {
      card.addEventListener('dblclick', function (e) {
        ...
        var input = (0, _domUtil.createDom)("<".concat(inputTag, " class=\"").concat(targetClass, "-input\" type=\"textarea\" style=\"width:").concat(width, "px; height: ").concat(height, "px\"/>"));
        var inputWrapper = (0, _domUtil.createDom)("<div class=\"".concat(targetClass, "-input-wrapper\" style=\"width: ").concat(width, "px; height: ").concat(height, "px margin-right: ").concat(computeStyle['marginRight'], "\" />"));
