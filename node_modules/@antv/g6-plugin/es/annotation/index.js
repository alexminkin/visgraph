  ...
  Annotation.prototype.bindListener = function (card, itemId) {
    ...
    if (editable) {
      card.addEventListener('dblclick', function (e) {
        ...
        var input = createDom("<".concat(inputTag, " class=\"").concat(targetClass, "-input\" type=\"textarea\" style=\"width:").concat(width, "px; height: ").concat(height, "px\"/>"));
        var inputWrapper = createDom("<div class=\"".concat(targetClass, "-input-wrapper\" style=\"width: ").concat(width, "px; height: ").concat(height, "px margin-right: ").concat(computeStyle['marginRight'], "\" />"));
